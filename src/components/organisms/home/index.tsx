...
export const Home = () => {
  return (
    <div className="grid grid-cols-12 bg-gradient-to-t from-gray-950 to-slate-900 h-screen">
      ...
      <div className="col-span-10 grid grid-cols-12 items-center gap-12 container text-white mx-auto px-8">
